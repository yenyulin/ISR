<%@ Page Language="C#" MasterPageFile="~/Template/member.master" AutoEventWireup="true"
    CodeFile="page6A2.aspx.cs" Inherits="Member_page6A2" %>
            ...
            <td height="25">
                <table width="90%" border="0" cellpadding="0" cellspacing="0" class="font1213-1">
                    <tr>
                        ...
                        <td class="qLink_font">
                            現在位置：<a href="Default.aspx">首頁</a> &gt;&gt; <a href="page6A2.aspx">會員專區 &gt;&gt; 研發合作對象
                            </a>
                        </td>
                    </tr>
                </table>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td rowspan="2" bgcolor="#F9F2F7" class="font1213-1">
                                            <div align="center">
                                                <div align="center">
                                                    <asp:CheckBox ID="PassCheckBox" runat="server" Checked='<%#(Eval("Isconfirm2").ToString().Equals("Y"))? true:false%>'
                                                        Visible='<%#(Eval("Isconfirm2").ToString().Equals("Y"))? false:true%>' ToolTip='<%#Eval("Id")%>' />
                                                    <asp:Label ID="Pass1" runat="server" Text="Y" Visible='<%#(Eval("Isconfirm2").ToString().Equals("Y"))? true:false%>'>
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </td>
