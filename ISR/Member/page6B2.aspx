<%@ Page Language="C#" MasterPageFile="~/Template/member.master" AutoEventWireup="true"
    CodeFile="page6B2.aspx.cs" Inherits="Member_page6B2" %>
            ...
            <td height="25">
                <table width="90%" border="0" cellpadding="0" cellspacing="0" class="font1213-1">
                    <tr>
                        ...
                        <td class="qLink_font">
                            現在位置：<a href="Default.aspx">首頁</a> &gt;&gt; <a href="page6B2.aspx">會員專區 &gt;&gt; 供需資料
                                &gt;&gt; 資源再生技術研發現況查詢 </a>
                        </td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    ...
                                    <td width="63%" class="table_title1">
                                        <div align="right" class="subfunction_font">
                                            | <a href="page6A2.aspx">研發合作對象</a> | <a href="page6B2.aspx">供需資訊</a> | <a href="page6C2.aspx">
                                                會員資料</a> |
                                        </div>
                                    </td>
                                </tr>
                ...
                <tr>
                    <td align="center">
                        <table width="760" border="0" align="center" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="ReuseGrid" runat="server" Width="100%" AutoGenerateColumns="False"
                                        AllowPaging="true" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Double"
                                        BorderColor="#663366" BorderWidth="1" OnPageIndexChanging="ReuseGrid_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="再生技術名稱">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="TechName" runat="server" OnCommand="Name_Command" CommandArgument='<%#Eval("Id")%>'><%# Eval("TechName")%></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="相關專利">
                                                <ItemTemplate>
                        ...
                        <table width="760" border="0" cellpadding="1" cellspacing="1" class="mtable">
                            <tr>
                                <td height="50" class="title3">
                                    &nbsp;
                                    <div align="center">
                                        <asp:Label ID="TechItem2" runat="server"></asp:Label>再生技術簡介及特點&nbsp;</div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="30" class="font1213-1">
                                    &nbsp;&nbsp;&nbsp;<asp:Label ID="TechAdv2" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td height="30" class="font1213-1">
                            ...
                            <tr>
                                <td height="30" class="font1213-1">
                                    &nbsp;&nbsp;&nbsp;<asp:Label ID="TechDesc2" runat="server"></asp:Label></td>
                            </tr>
                        </table>
                        <br />
