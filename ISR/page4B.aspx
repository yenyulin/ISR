<%@ Page Language="C#" MasterPageFile="~/Template/default.master" AutoEventWireup="true"
    CodeFile="page4B.aspx.cs" Inherits="page4_B" %>
...
<asp:Content ID="ContentCreateUser2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td height="25" style="width: 802px">
                <table width="90%" border="0" cellpadding="0" cellspacing="0" class="font1213-1">
                    <tr>
                        ...
                        <td class="qLink_font">
                            現在位置：<a href="#">首頁</a> &gt;&gt; <a href="#">會員註冊</a> &gt;&gt; <a href="page4B.aspx">
                                業者廠商會員註冊</a></td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <tr bgcolor="#e4f1e9" height="37">
                                        ...
                                        <td width="555" bgcolor="#f1e4ec" class="font1213-1" align="left">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="UserName"
                                                ValidationExpression="((.*[0-9])(.*[A-Za-z]))|((.*[A-Za-z])(.*[0-9]))" runat="server" ErrorMessage="帳號至少有一個英文字母、數字。"
                                                ToolTip="至少有一個英文字母、數字。" SetFocusOnError="True" ValidationGroup="CreateUserWizard1">*</asp:RegularExpressionValidator>
                                        ...
                                        <td colspan="2" bgcolor="#a996af" class="table_title1">
                                            <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#663333"
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#f9f2f7">
                                                        <asp:TextBox ID="WasteName" runat="server" Columns="8"></asp:TextBox>
                                                    ...
                                                    <td bgcolor="#f9f2f7">
                                                        <div align="center">
                                                                ...
                                                                <asp:TextBox ID="ReuseName" runat="server" Columns="11"></asp:TextBox>
                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ReuseName"
                                                            ErrorMessage="必須提供再生產品名稱。" ToolTip="必須提供再生產品名稱。" ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
