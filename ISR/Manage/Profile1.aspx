<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile1.aspx.cs" Inherits="Manage_Profile1" %>
                                    ...
                                    <table width="760" height="37" border="0" align="center" cellpadding="8" cellspacing="1"
                                        ...
                                        <tr bgcolor="#E4F1E9">
                                            ...
                                            <td bgcolor="#f9f2f7" class="font1213-1" align="left">
                                                ...
                                                <asp:RequiredFieldValidator ID="TechAdvRequired" runat="server" ControlToValidate="TechAdv2"
                                                    ErrorMessage="必須提供再生技術特點。" ToolTip="必須提供再生技術特點。" ValidationGroup="ValidationGroup2">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr bgcolor="#E4F1E9" height="37">
                                            <td bgcolor="#f1e4ec" class="table_title1" align="left">
                                            ...
                                            <td bgcolor="#f1e4ec" class="font1213-1" align="left">
                                                ...
                                                <asp:RequiredFieldValidator ID="TechDescRequired" runat="server" ControlToValidate="TechDesc2"
                                                    ErrorMessage="必須提供再生技術簡介。" ToolTip="必須提供再生技術簡介。" ValidationGroup="ValidationGroup2">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr bgcolor="#E4F1E9">
                                            <td colspan="2" align="center" bgcolor="#F1E4EC" class="table_title1">
