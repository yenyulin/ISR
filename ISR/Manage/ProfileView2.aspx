<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfileView2.aspx.cs" Inherits="Manage_ProfileView2" %>
            ...
            <table width="760" height="37" border="0" align="center" cellpadding="8" cellspacing="1"
                ...
                <tr bgcolor="#E4F1E9">
                    ...
                    <td bgcolor="#f9f2f7" class="font1213-1" align="left">
                        <asp:Label ID="OwnerView" runat="server">
                        </asp:Label>
                    </td>
                </tr>
                <tr bgcolor="#F2F9F4">
                        ...
                        <table width="760" height="37" border="0" align="center" cellpadding="8" cellspacing="1"
                            ...
                            <tr bgcolor="#A2CAD2">
                                <td height="30" colspan="2" bgcolor="#d2aaa2" class="font1213-1">
                                    <span class="form_title1">資源再生技術需求現況【<%# Container.ItemIndex + 1 %>】</span></td>
                            </tr>
                            <tr bgcolor="#E4F1E9">
