<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechView1.aspx.cs" Inherits="Manage_TechView1" %>
                    ...
                    <table width="760" height="37" border="0" align="center" cellpadding="8" cellspacing="1"
                        ...
                        <tr bgcolor="#F2F9F4">
                            <td bgcolor="#f9f2f7" class="table_title1" align="left">
                                再生技術特點:</td>
                            <td bgcolor="#f9f2f7" class="font1213-1" align="left">
                                <asp:TextBox ID="TechAdv" runat="server" Rows="5" TextMode="MultiLine" Columns="70"
                                    ReadOnly="true" Text='<%# Bind("TechAdv") %>'></asp:TextBox>
                            </td>
                        </tr>
                        <tr bgcolor="#E4F1E9">
                            <td bgcolor="#f1e4ec" class="table_title1" align="left">
                            ...
                            <td bgcolor="#f1e4ec" class="font1213-1" align="left">
                                <asp:TextBox ID="TextBox1" runat="server" Rows="5" TextMode="MultiLine" Columns="70"
                                    ReadOnly="true" Text='<%# Bind("TechDesc") %>'></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
